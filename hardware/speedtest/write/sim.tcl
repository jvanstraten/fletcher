...
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamPipelineBarrel.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamPipelineControl.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamSerializer.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/buffers/BufferWriterPreCmdGen.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/buffers/BufferWriterPrePadder.vhd {-quiet -work work -2008}
...
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamAccumulator.vhd {-quiet -work work -2008}
...
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamReshaper.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/buffers/BufferWriterCmdGenBusReq.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/buffers/BufferWriterPre.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/columns/ColumnReaderUnlockCombine.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/columns/ColumnWriterListSync.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/interconnect/BusWriteBuffer.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamElementCounter.vhd {-quiet -work work -2008}
...
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/buffers/BufferWriter.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/columns/ColumnWriterListPrim.vhd {-quiet -work work -2008}
...
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/columns/ColumnWriterLevel.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/interconnect/BusWriteArbiterVec.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/streams/StreamBuffer.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/columns/ColumnWriterArb.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/utils/SimUtils.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/columns/ColumnWriter.vhd {-quiet -work work -2008}
add_source $::env(FLETCHER_HARDWARE_DIR)/vhdl/wrapper/Wrapper.vhd {-quiet -work work -2008}
add_source ColumnWriterSpeed_tc.vhd {-quiet -work work -2008}
simulate work columnwriterspeed_tc "100 ms" 10
simulate work columnwriterspeed_tc "100 ms" 20
simulate work columnwriterspeed_tc "100 ms" 50
simulate work columnwriterspeed_tc "100 ms" 100
simulate work columnwriterspeed_tc "100 ms" 200
simulate work columnwriterspeed_tc "100 ms" 500
simulate work columnwriterspeed_tc "100 ms" 1000
simulate work columnwriterspeed_tc "100 ms" 2000
simulate work columnwriterspeed_tc "100 ms" 5000
simulate work columnwriterspeed_tc "100 ms" 10000
simulate work columnwriterspeed_tc "100 ms" 20000
simulate work columnwriterspeed_tc "100 ms" 50000
simulate work columnwriterspeed_tc "100 ms" 100000
